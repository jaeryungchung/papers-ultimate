...
children can attach off-the-shelf hardware (the popular and
...
## related works (research gap) - modular attachable device
children can attach off-the-shelf hardware (the popular and
relatively inexpensive micro:bit device) to their existing plush toys
and can design the toy to respond to custom movement of their
own design.
...
# research gap of interactive toy
- hard to implement
- underexplored : attachable modular device to put on any toy
